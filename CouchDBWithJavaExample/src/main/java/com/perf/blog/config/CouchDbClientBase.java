...
import static com.perf.blog.config.CouchDbUtil.assertNotEmpty;
import static com.perf.blog.config.CouchDbUtil.assertNull;
import static com.perf.blog.config.CouchDbUtil.close;
import static com.perf.blog.config.CouchDbUtil.generateUUID;
import static com.perf.blog.config.CouchDbUtil.getAsString;
import static com.perf.blog.config.CouchDbUtil.getStream;
import static com.perf.blog.config.CouchDbUtil.streamToString;
import static com.perf.blog.config.URIBuilder.buildUri;
...
public abstract class CouchDbClientBase {
	...
	public CouchDbClientBase(CouchDbConfig config) {
	 ...
	 */
	public URI getDBUri() {
		System.out.println("Ooh URI " + dbURI);
		return dbURI;
	}
